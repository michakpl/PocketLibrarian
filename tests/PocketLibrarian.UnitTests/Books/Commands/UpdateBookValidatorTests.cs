...
public sealed class UpdateBookValidatorTests
{
    ...
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), "Title", "Author", null, null);
    ...
    {
        var command = new UpdateBookCommand(Guid.Empty, Guid.NewGuid(), "Title", "Author", null, null);
    ...
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), new string('A', 257), "Author", null, null);
    ...
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), new string('A', 256), "Author", null, null);
    ...
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), "Title", new string('B', 257), null, null);
    ...
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), "Title", new string('B', 256), null, null);
    ...
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), "Title", "Author", new string('9', 51), null);

        var result = _validator.Validate(command);

        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateBookCommand.Isbn));
    }

    [Fact]
    public void IsbnAtMaxLength_PassesValidation()
    {
        var command = new UpdateBookCommand(Guid.NewGuid(), Guid.NewGuid(), "Title", "Author", new string('9', 50), null);
    ...
    public void NullIsbn_SkipsLengthValidation_PassesValidation()
    {
        ...
        Assert.True(result.IsValid);
        Assert.DoesNotContain(result.Errors, e => e.PropertyName == nameof(UpdateBookCommand.Isbn));
    }
}
